...
const real dt = 0.000; //time step (initial time step)
...
const unsigned int save_output_interval = 1000; //Interval to save results
const unsigned int save_output_interval_interpolated = 1000; //Interval to save interpolated results

// ========== SIMULATION CONTROL ========== //

//Case directory
std::string casePATH = "/home/jan/SPH_konvekce/tinySPH/cases/stillWater_mDBC/";
